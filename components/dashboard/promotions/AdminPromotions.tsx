...
import { Calendar, Check, RefreshCcw, Search } from 'lucide-react';
      ...
      <div className='flex flex-col gap-6 w-full border-b border-[#e5e5e6] pb-8'>
        ...
        <div className='flex flex-col gap-1.5 w-full'>
          ...
          <input
            ...
            className='w-full border border-[#e5e5e6] rounded-xs h-9 px-3 text-[13px] text-[#848995] bg-white outline-none focus:border-[#f09000]'
          />
        </div>
        ...
        <div className='flex flex-col gap-2 w-full mt-2'>
          <div className='flex items-center gap-3'>
            ...
            <button className='text-[13px] text-[#165dd0] hover:underline font-normal'>
              Update Banner
            </button>
          </div>

          <div className='w-full border border-dashed border-[#dcdce0] p-1 rounded-xs'>
            <div className='w-full h-62.5 sm:h-75 md:h-100 bg-[#ffca08] relative overflow-hidden rounded-xs flex'>
              <div className='flex-1 flex flex-col justify-center px-10 md:px-20 z-10'>
                <h1 className='text-white text-3xl sm:text-4xl md:text-5xl lg:text-[54px] font-bold leading-tight'>
                  Buy Your Favorite Plant
                </h1>
                <h1 className='text-white text-3xl sm:text-4xl md:text-5xl lg:text-[54px] font-bold leading-tight mt-2'>
                  From Plant Home
                </h1>
              </div>
              ...
              <div className='hidden md:flex flex-1 relative'>
                ...
                <div className='absolute right-[10%] top-1/2 -translate-y-1/2 flex flex-col gap-4'>
                  <Image
                    width={500}
                    height={500}
                    src='https://images.unsplash.com/photo-1592928304080-1e3f5b8c6f7d?q=80&w=500&auto=format&fit=crop'
                    className='w-75 h-auto object-contain drop-shadow-2xl mix-blend-multiply opacity-80'
                    alt='gift'
                  />
                </div>
              </div>
      ...
      <div className='flex flex-col gap-6 w-full'>
        ...
        <div className='flex flex-col sm:flex-row gap-6 w-full mt-2'>
          <div className='flex flex-col gap-1.5 w-full flex-1 relative'>
            ...
            <Calendar
              size={16}
              className='absolute right-3 top-8 text-[#b0b3b8] pointer-events-none'
            />
          </div>
          <div className='flex flex-col gap-1.5 w-full flex-1 relative'>
        ...
        <button className='w-full h-10 bg-[#f09000] hover:bg-[#e08600] transition-colors rounded-xs flex items-center justify-center gap-2 mt-6'>
