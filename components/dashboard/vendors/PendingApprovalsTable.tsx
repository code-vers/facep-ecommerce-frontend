...
const mockPendingStores = [
  { id: 1, checked: false, logo: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=64&auto=format&fit=crop', store: 'Plant House', vendor: 'John doe', email: 'jophn@Resu.com', date: '02.04.2026' },
  { id: 2, checked: true, logo: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?q=80&w=64&auto=format&fit=crop', store: 'Technet Au', vendor: 'John doe', email: 'jophn@Resu.com', date: '02.04.2026' },
  { id: 3, checked: true, logo: 'https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?q=80&w=64&auto=format&fit=crop', store: 'Technet Au', vendor: 'John doe', email: 'jophn@Resu.com', date: '02.04.2026' },
  { id: 4, checked: false, logo: 'https://images.unsplash.com/photo-1572635196237-14b3f281503f?q=80&w=64&auto=format&fit=crop', store: 'Technet Au', vendor: 'John doe', email: 'jophn@Resu.com', date: '02.04.2026' },
  { id: 5, checked: false, logo: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?q=80&w=64&auto=format&fit=crop', store: 'Technet Au', vendor: 'John doe', email: 'jophn@Resu.com', date: '02.04.2026' },
  { id: 6, checked: false, logo: 'https://images.unsplash.com/photo-1581235720704-06d3acfcb36f?q=80&w=64&auto=format&fit=crop', store: 'Technet Au', vendor: 'John doe', email: 'jophn@Resu.com', date: '02.04.2026' },
];
