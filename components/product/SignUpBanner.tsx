...
export default function SignUpBanner() {
  return (
    <section className='relative w-full min-h-[600px] bg-gradient-to-r from-[rgba(222,195,58,0.5)] via-[rgba(236,222,148,0.5)] via-[54.808%] to-[rgba(243,238,209,0.5)] py-10 xl:py-0'>
