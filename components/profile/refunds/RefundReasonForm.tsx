    ...
    <div className='flex flex-col gap-9 w-full'>
      ...
      <div className='flex flex-col gap-9 w-full'>
        ...
        {selectedItems.map((item) => (
          <div
            key={item.id}
            className='border border-[#e5e5e6] rounded-xs p-6 flex items-center gap-4 w-full'
          >
            <div className='relative w-25 h-25 rounded-xs shrink-0 overflow-hidden bg-gray-100'>
            ...
            <div className='flex-1 min-w-0 flex flex-col gap-4'>
              <div className='flex items-start justify-between gap-4 flex-wrap'>
                <div className='flex flex-col gap-1'>
                  ...
                  <span className='text-[12px] text-[#848995] leading-[1.3]'>{item.seller}</span>
                </div>
              ...
              <span className='text-[22px] font-normal text-black leading-[1.2]'>{item.price}</span>
            </div>
          </div>
        ))}
      ...
      <div className='flex items-center justify-end gap-4 mt-8 w-full'>
        <button
          type='button'
          onClick={onBack}
          className='flex items-center justify-center py-3 px-6 rounded-xs border border-[#686f7d] text-black hover:bg-gray-50 transition-all cursor-pointer min-w-20 h-12'
        >
        ...
        <button
          ...
          className={cn(
            'flex items-center justify-center py-3 px-6 rounded-xs transition-all min-w-20 h-12',
            isValid
