      ...
      <div className="bg-white border border-[#e5e5e6] flex flex-col items-start p-[40px] relative rounded-[6px] w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex flex-col gap-[24px] items-start w-full text-left">
          ...
          <div className="flex flex-col gap-[8px] items-start w-full">
            ...
            <div className="border border-[#cacbce] border-dashed flex flex-col gap-[12px] h-[154px] items-center justify-center rounded-[6px] w-full bg-gray-50/50 hover:bg-gray-50 cursor-pointer transition-colors">
          ...
          <div className="flex justify-end items-center gap-4 w-full pt-4">
            ...
            <button 
              className="bg-[#dec33a] hover:bg-[#c9b030] px-6 py-2.5 rounded-[2px] font-semibold text-black transition-colors cursor-pointer"
              onClick={() => {
