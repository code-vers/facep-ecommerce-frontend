...
const FALLBACK_ASSET = 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?q=80&w=800&auto=format&fit=crop';
...
export default function TodaysDealCta() {
  ...
  return (
    ...
    >
      <div 
        className="mx-auto w-full max-w-[1760px] px-4 sm:px-6 md:px-8 lg:px-10 xl:px-16 2xl:px-20 h-full flex items-center justify-center"
      >
            ...
            {session ? (
              <>
                ...
                <p className="font-sans font-normal leading-[1.2] text-[18px] sm:text-[22px] text-black">
                  Logged in as <span className="font-semibold">{session.fullName}</span>
                </p>
              </>
            ) : (
              <>
